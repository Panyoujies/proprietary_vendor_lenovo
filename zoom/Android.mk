...
include $(CLEAR_VARS)
LOCAL_MODULE       := pp_calib_data_boe_1080p_cmd_mode_dsi_panel.xml
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS  := optional
LOCAL_SRC_FILES    := proprietary/etc/pp_calib_data_boe_1080p_cmd_mode_dsi_panel.xml
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE       := pp_calib_data_lgd_1080p_cmd_mode_dsi_panel.xml
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS  := optional
LOCAL_SRC_FILES    := proprietary/etc/pp_calib_data_lgd_1080p_cmd_mode_dsi_panel.xml
include $(BUILD_PREBUILT)
